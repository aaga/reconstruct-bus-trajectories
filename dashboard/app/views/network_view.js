...
// spec: enabled ONLY when exactly one route is selected — whole-network
// views have no direction filter (a seg_id already encodes one direction of
// travel; "direction" only means something relative to a chosen route).
// (Corridor filtering/selection removed 2026-07 pending rework.)
...
export class NetworkView {
  ...
  // Direction options depend on the single-route selection (spec rule).
  ...
  // ---- segment selection under route/direction ---------------------------
